...
public class TableDeProblemesController {
    ...
    @FXML
    private TableView<ExceptionProgramme> tableDeProblemes; /// tables ou s'affiche les problemes � resoudre dans le circuit
    ...
    public void initialiser() { /// sert pour le remplissage de la table des erreurs
    	...
    	tableDeProblemes.getItems().addAll(Circuit.getListeExceptionProgrammes()); /// ajout des exceptions d�tect� dans le circuit
