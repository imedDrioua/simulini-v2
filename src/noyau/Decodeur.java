...
public class Decodeur extends Combinatoires{	
	...
	public void genererSorties() { 
		...
		for(int i = 0 ; i < nombreSortie ; i++) { // mettre � 1 l'etat du fil correspondant en sortie 
			if (i == s)
	...
	public boolean valider() { // verifier si les entrees sont toutes valid�es
		return (validerEntrees().getNum() == 1)  ? true : false;
	}

	@Override
	public void setCord() { /// seter les coordonn�es d'entrees/sorties
