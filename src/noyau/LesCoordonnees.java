...
public class LesCoordonnees implements Serializable{
	...
	public int indexCoord(Coordonnees crd) { /// savoir le numero d'entree qui contient les coordonn�es pass� comme parametre
		int i = 0;
	...
	public void rotationXY(ImageView imageView) { /// faire une rotation du composant
		double perm ;
		for(int i=0;i<nbCordEntree;i++) { /// inverser les coordonn�es x et y des entrees
